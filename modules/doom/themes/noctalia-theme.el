...
(let* ((bg "#10111b")
      (err "#f08a9b")
      (err-container "#b4132e")
      (on-background "#eee7f0")
      (on-err "#2d0b14")
      (on-err-container "#f9d2d8")
      (on-primary "#2b1422")
      (on-primary-container "#f4d7e6")
      (on-secondary "#1d1830")
      (on-secondary-container "#e0dbf0")
      (on-surface "#eee7f0")
      (on-surface-variant "#c8b9ca")
      (on-tertiary "#071f2d")
      (on-tertiary-container "#d8e9f3")
      (outline-color "#645d74")
      (outline-variant "#3f3b4a")
      (primary "#e6a6c8")
      (primary-container "#b12971")
      (secondary "#afa2d8")
      (secondary-container "#4a3295")
      (shadow "#05060a")
      (surface "#10111b")
      (surface-container "#1d1a2a")
      (surface-container-high "#262237")
      (surface-container-highest "#2e2a43")
      (surface-container-low "#161522")
      (surface-container-lowest "#12121e")
      (surface-variant "#1d1a2a")
      (tertiary "#7fb6d6")
      (tertiary-container "#225e81")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#7fb6d6")
      (on-success "#071f2d")
      (success-container "#225e81")
      (on-success-container "#d8e9f3")
      ;; Map fixed colors to regular colors
      (primary-fixed "#e6a6c8")
      (primary-fixed-dim "#b12971")
      (secondary-fixed "#afa2d8")
      (secondary-fixed-dim "#4a3295")
      (tertiary-fixed "#7fb6d6")
      (tertiary-fixed-dim "#225e81")
      (on-primary-fixed "#2b1422")
      (on-primary-fixed-variant "#f4d7e6")
      (on-secondary-fixed "#1d1830")
      (on-secondary-fixed-variant "#e0dbf0")
      (on-tertiary-fixed "#071f2d")
      (on-tertiary-fixed-variant "#d8e9f3")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#eee7f0")
      (inverse-primary "#e6a6c8")
      (inverse-surface "#10111b")
