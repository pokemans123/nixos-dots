...
(let* ((bg "#0c141b")
      ...
      (on-primary "#003734")
      (on-primary-container "#71f7ed")
      (on-secondary "#003734")
      (on-secondary-container "#9df2ea")
      (on-surface "#dbe3ed")
      (on-surface-variant "#b7c9d9")
      (on-tertiary "#00344d")
      (on-tertiary-container "#c8e6ff")
      (outline-color "#8193a2")
      (outline-variant "#384956")
      (primary "#4fdbd1")
      (primary-container "#00504c")
      (secondary "#81d5ce")
      ...
      (surface-variant "#384956")
      (tertiary "#94cdf7")
      (tertiary-container "#004c6e")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#94cdf7")
      (on-success "#00344d")
      (success-container "#004c6e")
      (on-success-container "#c8e6ff")
      ;; Map fixed colors to regular colors
      (primary-fixed "#4fdbd1")
      (primary-fixed-dim "#00504c")
      (secondary-fixed "#81d5ce")
      (secondary-fixed-dim "#00504c")
      (tertiary-fixed "#94cdf7")
      (tertiary-fixed-dim "#004c6e")
      (on-primary-fixed "#003734")
      (on-primary-fixed-variant "#71f7ed")
      (on-secondary-fixed "#003734")
      (on-secondary-fixed-variant "#9df2ea")
      (on-tertiary-fixed "#00344d")
      (on-tertiary-fixed-variant "#c8e6ff")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#dbe3ed")
      (inverse-primary "#4fdbd1")
      (inverse-surface "#0c141b")
