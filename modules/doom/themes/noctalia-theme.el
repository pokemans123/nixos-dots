...
(let* ((bg "#291415")
      (err "#99272f")
      (err-container "#430a0e")
      (on-background "#f3f2f2")
      (on-err "#d3c0c2")
      (on-err-container "#f5d6d8")
      (on-primary "#251819")
      (on-primary-container "#f5d6d8")
      (on-secondary "#251819")
      (on-secondary-container "#f5e3d6")
      (on-surface "#f3f2f2")
      (on-surface-variant "#b6afaf")
      (on-tertiary "#251819")
      (on-tertiary-container "#f5f3d6")
      (outline-color "#716263")
      (outline-variant "#756161")
      (primary "#e46770")
      (primary-container "#8d0c15")
      (secondary "#d6905c")
      (secondary-container "#6f3910")
      (shadow "#291415")
      (surface "#291415")
      (surface-container "#452124")
      (surface-container-high "#3e1e20")
      (surface-container-highest "#4c2527")
      (surface-container-low "#221112")
      (surface-container-lowest "#150a0b")
      (surface-variant "#371b1c")
      (tertiary "#d6cd5c")
      (tertiary-container "#6f6810")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#d6cd5c")
      (on-success "#251819")
      (success-container "#6f6810")
      (on-success-container "#f5f3d6")
      ;; Map fixed colors to regular colors
      (primary-fixed "#e46770")
      (primary-fixed-dim "#8d0c15")
      (secondary-fixed "#d6905c")
      (secondary-fixed-dim "#6f3910")
      (tertiary-fixed "#d6cd5c")
      (tertiary-fixed-dim "#6f6810")
      (on-primary-fixed "#251819")
      (on-primary-fixed-variant "#f5d6d8")
      (on-secondary-fixed "#251819")
      (on-secondary-fixed-variant "#f5e3d6")
      (on-tertiary-fixed "#251819")
      (on-tertiary-fixed-variant "#f5f3d6")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#f3f2f2")
      (inverse-primary "#e46770")
      (inverse-surface "#291415")
