...
(let* ((bg "#0e1415")
      ...
      (outline-color "#899393")
      (outline-variant "#3f4949")
      (primary "#80d4d9")
      (primary-container "#004f53")
      (secondary "#b1cccd")
      ...
      (success "#b5c7e9")
      (on-success "#1f314c")
      (success-container "#364764")
      (on-success-container "#d5e3ff")
      ;; Map fixed colors to regular colors
      (primary-fixed "#80d4d9")
      (primary-fixed-dim "#004f53")
      (secondary-fixed "#b1cccd")
      (secondary-fixed-dim "#324b4c")
      (tertiary-fixed "#b5c7e9")
      (tertiary-fixed-dim "#364764")
      (on-primary-fixed "#003739")
      (on-primary-fixed-variant "#9cf0f5")
      (on-secondary-fixed "#1b3436")
      (on-secondary-fixed-variant "#cce8e9")
      (on-tertiary-fixed "#1f314c")
      (on-tertiary-fixed-variant "#d5e3ff")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#dde4e4")
      (inverse-primary "#80d4d9")
      (inverse-surface "#0e1415")
