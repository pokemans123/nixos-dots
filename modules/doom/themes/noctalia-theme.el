...
(let* ((bg "#1a1a1a")
      (err "#ffa0a0")
      (err-container "#ed0000")
      (on-background "#ffdacc")
      (on-err "#1a1a1a")
      (on-err-container "#0f0001")
      (on-primary "#1a1a1a")
      (on-primary-container "#f3d8d8")
      (on-secondary "#1a1a1a")
      (on-secondary-container "#ffe5cc")
      (on-surface "#ffdacc")
      (on-surface-variant "#f0ebe6")
      (on-tertiary "#1a1a1a")
      (on-tertiary-container "#3f3c1e")
      (outline-color "#70635a")
      (outline-variant "#463e38")
      (primary "#d06666")
      (primary-container "#691a1a")
      (secondary "#ffa247")
      (secondary-container "#934900")
      (shadow "#050505")
      (surface "#1a1a1a")
      ...
      (surface-variant "#080808")
      (tertiary "#f0e68c")
      (tertiary-container "#b6a614")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#f0e68c")
      (on-success "#1a1a1a")
      (success-container "#b6a614")
      (on-success-container "#3f3c1e")
      ;; Map fixed colors to regular colors
      (primary-fixed "#d06666")
      (primary-fixed-dim "#691a1a")
      (secondary-fixed "#ffa247")
      (secondary-fixed-dim "#934900")
      (tertiary-fixed "#f0e68c")
      (tertiary-fixed-dim "#b6a614")
      (on-primary-fixed "#1a1a1a")
      (on-primary-fixed-variant "#f3d8d8")
      (on-secondary-fixed "#1a1a1a")
      (on-secondary-fixed-variant "#ffe5cc")
      (on-tertiary-fixed "#1a1a1a")
      (on-tertiary-fixed-variant "#3f3c1e")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#ffdacc")
      (inverse-primary "#d06666")
