...
(let* ((bg "#1c1c1c")
      (err "#fd1b22")
      (err-container "#660003")
      (on-background "#f8f8f2")
      (on-err "#141414")
      (on-err-container "#ffccce")
      (on-primary "#f8f8f2")
      (on-primary-container "#f7d4d9")
      (on-secondary "#141414")
      (on-secondary-container "#ffd1cc")
      (on-surface "#f8f8f2")
      (on-surface-variant "#f0e68c")
      (on-tertiary "#141414")
      (on-tertiary-container "#464225")
      (outline-color "#676767")
      (outline-variant "#414141")
      (primary "#9b1b30")
      (primary-container "#470610")
      (secondary "#ff6f61")
      (secondary-container "#ae0f00")
      (shadow "#000000")
      (surface "#1c1c1c")
      (surface-container "#3d3d3d")
      (surface-container-high "#474747")
      (surface-container-highest "#515151")
      (surface-container-low "#2c2c2c")
      (surface-container-lowest "#222222")
      (surface-variant "#3d3d3d")
      (tertiary "#f0e68c")
      (tertiary-container "#c1af08")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#f0e68c")
      (on-success "#141414")
      (success-container "#c1af08")
      (on-success-container "#464225")
      ;; Map fixed colors to regular colors
      (primary-fixed "#9b1b30")
      (primary-fixed-dim "#470610")
      (secondary-fixed "#ff6f61")
      (secondary-fixed-dim "#ae0f00")
      (tertiary-fixed "#f0e68c")
      (tertiary-fixed-dim "#c1af08")
      (on-primary-fixed "#f8f8f2")
      (on-primary-fixed-variant "#f7d4d9")
      (on-secondary-fixed "#141414")
      (on-secondary-fixed-variant "#ffd1cc")
      (on-tertiary-fixed "#141414")
      (on-tertiary-fixed-variant "#464225")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#f8f8f2")
      (inverse-primary "#9b1b30")
