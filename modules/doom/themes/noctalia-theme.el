...
(let* ((bg "#0b0e14")
      (err "#d95757")
      (err-container "#700e0e")
      (on-background "#d1d1c7")
      (on-err "#0b0e14")
      (on-err-container "#f6d5d5")
      (on-primary "#0b0e14")
      (on-primary-container "#d2eff9")
      (on-secondary "#0b0e14")
      (on-secondary-container "#ebf6d5")
      (on-surface "#d1d1c7")
      (on-surface-variant "#8e959e")
      (on-tertiary "#0b0e14")
      (on-tertiary-container "#f9ecd2")
      (outline-color "#595f6a")
      (outline-variant "#363a40")
      (primary "#39bae6")
      (primary-container "#044f68")
      (secondary "#aad94c")
      (secondary-container "#49670b")
      (shadow "#000000")
      (surface "#0b0e14")
      (surface-container "#1e222a")
      (surface-container-high "#272c36")
      (surface-container-highest "#2f3542")
      (surface-container-low "#14181f")
      (surface-container-lowest "#0e1218")
      (surface-variant "#1e222a")
      (tertiary "#e6b450")
      (tertiary-container "#7d5507")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#e6b450")
      (on-success "#0b0e14")
      (success-container "#7d5507")
      (on-success-container "#f9ecd2")
      ;; Map fixed colors to regular colors
      (primary-fixed "#39bae6")
      (primary-fixed-dim "#044f68")
      (secondary-fixed "#aad94c")
      (secondary-fixed-dim "#49670b")
      (tertiary-fixed "#e6b450")
      (tertiary-fixed-dim "#7d5507")
      (on-primary-fixed "#0b0e14")
      (on-primary-fixed-variant "#d2eff9")
      (on-secondary-fixed "#0b0e14")
      (on-secondary-fixed-variant "#ebf6d5")
      (on-tertiary-fixed "#0b0e14")
      (on-tertiary-fixed-variant "#f9ecd2")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#d1d1c7")
      (inverse-primary "#39bae6")
