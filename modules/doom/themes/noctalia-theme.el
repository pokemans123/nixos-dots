...
(let* ((bg "#0f131c")
      ...
      (on-primary "#003640")
      (on-primary-container "#a9edff")
      (on-secondary "#003640")
      (on-secondary-container "#a9edff")
      (on-surface "#dfe2ef")
      (on-surface-variant "#bfc6dc")
      (on-tertiary "#102f60")
      (on-tertiary-container "#d8e2ff")
      (outline-color "#8991a5")
      ...
      (surface-variant "#3f4759")
      (tertiary "#adc6ff")
      (tertiary-container "#2b4678")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#adc6ff")
      (on-success "#102f60")
      (success-container "#2b4678")
      (on-success-container "#d8e2ff")
      ;; Map fixed colors to regular colors
      (primary-fixed "#54d6f3")
      (primary-fixed-dim "#004e5c")
      (secondary-fixed "#84d2e6")
      (secondary-fixed-dim "#004e5c")
      (tertiary-fixed "#adc6ff")
      (tertiary-fixed-dim "#2b4678")
      (on-primary-fixed "#003640")
      (on-primary-fixed-variant "#a9edff")
      (on-secondary-fixed "#003640")
      (on-secondary-fixed-variant "#a9edff")
      (on-tertiary-fixed "#102f60")
      (on-tertiary-fixed-variant "#d8e2ff")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#dfe2ef")
      (inverse-primary "#54d6f3")
      (inverse-surface "#0f131c")
